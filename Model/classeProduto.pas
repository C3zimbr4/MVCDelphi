...
begin
   ...
   try
     conecta.FDQuery1.SQL.Add('select descricao from produto where idproduto = ' + IntToStr(FCodigo));
     try
...
begin
   ...
   conecta := TConexao.Create;
   try
     conecta.FDQuery1.SQL.Add('select preco from produto where idproduto = ' + IntToStr(FCodigo));
     try
       conecta.FDQuery1.Open;
